...
<html>
	<head>
		<meta charset="utf-8" />
		<title>Adicionar dissertação | Editora Paralogike</title>
	...
	<body>
		<div class="container">
	      ...
	      <?php include("menu.php") ?>
	      	...
	      	<main>
	      		<h2 class="">Adicionar dissertação</h2>
	      		<hr>
	      		<!-- form -->
	      		<form method="POST" enctype="multipart/form-data" action="<?= base_url(); ?>admin/adicionardissertacao" class="form-horizontal">
	      			
	      			<input type="hidden" name="tipo" value="dissertacao">
	      			...
	      			<div class="form-group">
	      				...
	      				<div class="col-md-8">
	      					<input type="text" class="form-control" name="autor" id="autor" placeholder="Digite o autor" pattern="[A-Za-z]" required>
	      				</div>
	      			</div>
	      			...
	      			<div class="form-group">
	      				...
	      				<div class="col-md-8">
	      					<input type="text" class="form-control" name="orientador" id="orientador" placeholder="Digite o orientador" pattern="[A-Za-z]" required>
	      				</div>
	      			</div>
	      			...
	      			<div class="form-group">
	      				...
	      				<div class="col-md-8">
	      					<input type="text" class="form-control" name="coorientador" id="coorientador" placeholder="Digite o co-orientador" pattern="[A-Za-z]">
	      				</div>
	      			</div>
