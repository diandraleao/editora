...
<html>
	<head>
		<meta charset="utf-8" />
		<title>Listar dissertações | Editora Paralogike</title>
		...
		<script type="text/javascript">
		    ...
		    function send_data(campo){
				...
				var url = "<?= base_url(); ?>admin/deletardissertacao/" + $(campo).attr("data-id-excluir");//.getAttribute('data-id-excluir');
	...
	<body>
		<div class="container">
			<img src="../../static/img/logo.jpg" alt="logo editora paralogike" class="img-responsive logo center-block ">
	      	...
	      	<main>
	      		<h2 class="">Listar dissertações</h2>
	      		<hr>
	      		<div class="row">
	      			<div class="col-md-12">
