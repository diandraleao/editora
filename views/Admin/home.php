...
<html>
	<head>
		<meta charset="utf-8" />
		<title>Administração | Editora Paralogike</title>
		...
		<div class="container">
			<img src="../../static/img/logo.jpg" alt="logo editora paralogike" class="img-responsive logo center-block ">
	      	...
	      	<main>
				...
				<!--Colocar instruções de uso de admin -->
				<p>Suco de cevadiss, é um leite divinis, qui tem lupuliz, matis, aguis e fermentis. Interagi no mé, cursus quis, 
				vehicula ac nisi. Aenean vel dui dui. Nullam leo erat, aliquet quis tempus a, posuere ut mi. Ut scelerisque neque
				et turpis posuere pulvinar pellentesque nibh ullamcorper. Pharetra in mattis molestie, volutpat elementum justo. 
