<?php if (!defined('BASEPATH')) exit('No direct script access allowed');
    ...
    class Teses_dao extends CI_Model {
        ...
        public function insert(array $publicacao ){
            ...
            $this->db->insert('TB_Teses', $publicacao[1]);
        }
        ...
        public function get_all_id_title_date(){
			...
			$this->db->from('TB_Teses');

			$this->db->join('TB_Publicacoes', 'TB_Publicacoes.id_publicacao = TB_Teses.id_publicacao');
        ...
        public function delete($id){
            ...
            $tables = array('TB_Teses','TB_Publicacoes');
